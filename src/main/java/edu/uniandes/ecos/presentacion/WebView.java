...
public class WebView {
	 ...
	 public void showHome(HttpServletRequest req, HttpServletResponse resp)  throws ServletException, IOException {
		  	...
		  	content += "<tr>";
		  	content +="<th><label for=\"varx\">Valor de X: </label></th>";
		  	content +="<td style=\"text-align: center;\"><input type=\"text\" name=\"varx\" id=\"varx\"  placeholder=\"Ingrese el valor de x.\" ></td>";
		  	content +="</tr>";
		  	content += "<tr>";
		  	...
		  	content +="</tr>";
		  	content += "<tr>";
		  	content +="<th><label for=\"segments\">Cantidad de segmentos: </label></th>";
		  	content +="<td style=\"text-align: center;\"><input type=\"text\" name=\"segments\" id=\"segments\"  placeholder=\"Número entero\" ></td>";
		  	content +="</tr>";
		  	content +="<tr>";
	...
	private void writePage(PrintWriter pw, String content){
	  	pw.write("<html>");
	  	pw.write("<head><title>PSP2</title></head>");
	  	pw.write("<body>");
	  	pw.println("<h3> Cálculo de integral usando método Simpson. </h3>");
	  	pw.write(content);
	  	pw.write("</body>");
	  	pw.write("</html>");
	}
